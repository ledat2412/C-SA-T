                ...
                ItemTemplate = new DataTemplate(() =>
                {
                    ...
                    btnDetail.Clicked += async (s, e) =>
                    {
                        try
                        {
                            ...
                            if (gianHang == null)
                            {
                                await DisplayAlert("Debug", "gianHang đang null", "OK");
                                return;
                            }

                            await DisplayAlert("Debug", $"Stack hiện tại: {Navigation.NavigationStack.Count}", "OK");
...
<<<<<<< HEAD
        ...
        private View BuildFooter()
        {
            ...
            var explore = BuildFooterItem("🧭", "Khám phá", true);
...
<<<<<<< HEAD
            try
            {
                ...
                if (_items.Count == 0)
                {
                    await DisplayAlert("Thông báo", "Không có dữ liệu gian hàng.", "OK");
                }
            }
            catch (Exception ex)
            {
